# Urent-api
Urent API reverse engineering &amp; Python client. Полное API шеринга самокатов Юрент + авторизация

Telegram - @ya_prgm

в API.md описанны все эндпоинты и авторизация, в urent.py - python клиент, для работы с Юрент API, в work.py - пример скрипта, ищет активные самокаты
...
## 11. Дисклеймер
**Данная документация предназначена исключительно для образовательных целей и ознакомления с принципами работы мобильных API. Автор не несет ответственности за использование данных методов в целях, нарушающих правила сервиса Urent.**
